...
def join(
    ...
    >>> core.join([df1, df2, df3], on="a", how="left")
       a  b  c    d
    0  1  3  5  7.0
    1  2  4  6  NaN
    """
...
def union(dataframes: Iterable[PandasDF]) -> PandasDF:
    ...
    5  NaN  NaN  6.0
    """
    return pd.concat(map(pd.DataFrame, dataframes), axis=0, ignore_index=True)
