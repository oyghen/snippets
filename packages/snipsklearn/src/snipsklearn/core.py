...
def precision_given_recall(
    ...
    *,
    ...
    ...     core.precision_given_recall(y_true, y_score, min_recall=0.7)
...
def precision_given_recall_score(
    ...
    *,
    ...
    >>> y_true = [0, 1, 1, 1, 0, 0, 0, 1]
    >>> y_score = [0.1, 0.4, 0.35, 0.8, 0.5, 0.2, 0.75, 0.5]
    >>> core.precision_given_recall_score(y_true, y_score, min_recall=0.7)
    0.6
    """
...
def precision_given_recall_summary(
    ...
    *,
    ...
    ...     core.precision_given_recall_summary(y_true, y_score, min_recall=0.7).T
                            0
    threshold          0.4000
...
def precision_recall_values(
    ...
    *,
    ...
    >>> y_score = [0.1, 0.4, 0.35, 0.8, 0.5, 0.2, 0.75, 0.5]
    >>> with pd.option_context("display.float_format", "{:.2f}".format):
    ...     core.precision_recall_values(y_true, y_score)
       threshold  precision  recall
    0       0.10       0.50    1.00
    1       0.20       0.57    1.00
    2       0.35       0.67    1.00
